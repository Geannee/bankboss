<%-- 
    ...
    Created on : 4 de jun. de 2025, 16:27:26
    Author     : Hially
--%>
...
List<Cliente> todosClientes = new ArrayList<>();
    if(busca != null){
        if(busca.equals("todos")){//busca todos
            todosClientes = clienteControl.buscarTodos();
           /* for (Cliente cliente : todosClientes) {
            ...
            todosClientes = clienteControl.buscarPorNome(nomeCliente);
        }
    }else{
...
<div class="container-form">
  <!-- Buscar por Nome -->
  <form method="get" action="consultaCliente.jsp">
    <div class="field-group">
      <label for="nome">Nome:</label>
      <input type="text" id="nome" name="nomeCliente" placeholder="Digite o nome">
    ...
    <table class="clientes-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="center">
            <a href="visualizarCliente.jsp?id=<%= cliente.getId_cliente() %>" title="Visualizar" class="icon-link blue"><i class="fas fa-eye"></i></a>
            <a href="editarCliente.jsp?id=<%= cliente.getId_cliente() %>" title="Editar" class="icon-link yellow"><i class="fas fa-edit"></i></a>
            <a href="desabilitarCliente.jsp?id=<%= cliente.getId_cliente() %>" title="Desabilitar" class="icon-link red"><i class="fas fa-user-slash"></i></a>
          </td>
        </tr>
        <%
          }
